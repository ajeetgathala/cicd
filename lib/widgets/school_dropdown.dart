...
class SchoolDropDown extends StatefulWidget {
  final String? title;
  final List<SchoolsDataModel> items;
  final bool isInvalid;
  final int? selectedIndex;
  final SchoolsDataModel selectedItem;
  final Function(SchoolsDataModel) selectedValue;
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      widget.selectedItem.schoolName ?? AppStrings.select,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
                          color: widget.selectedItem.schoolName!.isEmpty
                              ? AppColors.gray
                              : AppColors.blueDark),
                    ),
                  ),
